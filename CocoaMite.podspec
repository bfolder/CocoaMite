...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Heiko Dreyer" => "mail@boxedfolder.com", "other author" => "email@address.com" }
  # s.author       = 'Heiko Dreyer', 'other author'
  ...
  s.source       = { :git => "http://github.com/bfolder/CocoaMite.git", :tag => "0.0.1" }
